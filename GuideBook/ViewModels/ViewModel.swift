    ...
    func getDescription(_ str: String) -> String{
        ...
        case "karakol":
           return """
            ...
            Karakol has Central Asia's highest ski resort, with 20 km of slopes, situated just 20 minutes from the town. Unlike Shymbulak resort, the riding at Karakol includes forest areas as well as cleared trails.
            ...
            The cathedral was originally built of stone in 1872, when Karakol was a garrison town established as an outpost on the edges of the Tsarist Russian Empire. It was destroyed in 1890 by an earthquake and the current cathedral was built out of wood on a brick base. It took six years to complete, and was finally completed in 1895. During the period of construction, a yurt served the congregation as a church. It has seen considerable service, not just as a church. During an anti-Russian uprising in 1916 its monks were brutally murdered.
        ...
        case "Osh":
          return  """
            ...
            Osh city covers 182.5 square kilometres (70.5 square miles) and like the capital city Bishkek, is administered separately and not part of any region, although it is the seat of Osh Region. Besides the city proper, 11 villages are administered by the city: Almalyk, Arek, Gulbaar-Toloykon, Japalak, Kengesh, Kerme-Too, Orke, Pyatiletka, Teeke and parts of Ozgur and Tölöykön.
        ...
        case "Naryn":
          return  """
            Naryn is the regional administrative center of Naryn Region in central Kyrgyzstan. Its area is 84 square kilometres (32 sq mi), and its estimated population was 40,000 as of January 2019. The town was established as a fortress on the caravan route in 1868. It is situated on both banks of the Naryn River (one of the main head waters of the Syr Darya), which cuts a picturesque gorge through the town. The city has two regional museums and some hotels, but is otherwise residential.
