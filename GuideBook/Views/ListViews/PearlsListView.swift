            ...
            ScrollView(.vertical, showsIndicators: false){
                ZStack{
                    VStack(alignment: .center, spacing: 12){
                        ForEach(vm.selectedPearls) { place in
                            GeometryReader{ geo in
                                PearlView(city: place, showText: geo.frame(in: .global).minY > UIScreen.main.bounds.height / 4 * 3)
